...
-- Views with 2 Tables (2)



-- VIEW --
CREATE VIEW select_warehouses_locations AS
SELECT
...
-- Execute
SELECT * FROM select_warehouses_locations;


-- VIEW --
CREATE VIEW select_locations_countries AS
SELECT
...
-- Execute 
SELECT * FROM select_locations_countries;



-- Views with 3 tables (3)



-- VIEW --
CREATE VIEW select_products_inventory_and_category AS
SELECT 
...
-- Execute 
SELECT * FROM select_products_inventory_and_category;


-- VIEW --
CREATE VIEW select_orders_items_by_costumer AS
SELECT 
orders.order_id,
orders.status,
order_items.item_id,
...
-- Execute 
SELECT * FROM select_orders_items_by_costumer;


-- VIEW --
CREATE VIEW select_orders_customers_by_salesman AS
SELECT 
orders.order_id,
(employees.first_name) AS salesman_first_name,
(employees.last_name) AS salesman_last_name,
customers.name
FROM orders
...
-- Execute 
SELECT * FROM select_orders_customers_by_salesman;



-- Views with 5 tables (2)




-- VIEW --
CREATE VIEW select_orders_products AS
SELECT
orders.order_id,
products.product_name,
...
-- Execute 
SELECT * FROM select_orders_products;



-- VIEW --
CREATE VIEW select_orders_people_by_items AS
SELECT
order_items.product_id,
orders.order_id,
(customers.name) AS customer_name,
(contacts.email) AS customer_email,
(employees.first_name) AS salesman
FROM orders
...
-- Execute 
SELECT * FROM select_orders_people_by_items;




-- Views with 7 tables (3)




-- VIEW --
CREATE VIEW select_orders_data AS
SELECT
orders.order_id,
(customers.name) AS customer_name,
(contacts.email) AS customer_email,
...
-- Execute 
SELECT * FROM select_orders_data


-- VIEW --
CREATE VIEW select_products_data AS
SELECT
products.product_name,
product_categories.category_name,
inventories.quantity,
...
INNER JOIN locations
ON warehouses.warehouse_id = locations.location_id
...
-- Execute 
SELECT * FROM select_products_data;


-- VIEW --
CREATE VIEW select_orders_products_data AS
SELECT
orders.order_id,
order_items.item_id,
products.product_name,
...
INNER JOIN warehouses
ON inventories.product_id = warehouses.warehouse_id
...
-- Execute 
SELECT * FROM select_orders_products_data;
