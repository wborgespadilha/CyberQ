...
export default{
  ...
  methods:{
    async mount(){
      await fetch("https://localhost:7279/api/categorias")
      ...
      await fetch(`https://localhost:7279/api/comentarios`)
      .then(postagem => postagem.json())
        ...
        <nav class="navbar navbar-expand-lg bg-light">
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                  <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="#" v-on:click="this.logar()">Login</a>
                  </li>
                </ul>
