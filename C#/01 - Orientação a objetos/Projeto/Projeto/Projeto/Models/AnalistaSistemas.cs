...
{
    internal class AnalistaSistemas : Funcionario
    {
        public AnalistaSistemas(string Nome, double ValorHora, int HorasExtras50, int HorasExtras100) : base(Nome, ValorHora, HorasExtras50, HorasExtras100)
        {
            this.Nome = Nome;
