...
namespace Blog
{
    public partial class Pesquisa : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var codigo = Request.QueryString["termo"];
            ...
            try
            {
                ...
                cmd.CommandText = "SELECT postagens.id_post, postagens.titulo, categorias.nome, postagens.texto " +
                    "FROM postagens INNER JOIN categorias ON categorias.id_categoria = postagens.fk_categoria " +
                    $"WHERE postagens.titulo LIKE '%{codigo}%' or postagens.texto LIKE '%{codigo}%' ";
                cmd.Connection = con;
        ...
        {
            Response.Redirect("Sessao.aspx?usuario=" + Usuario.Text + "&senha=" + Senha.Text);
        }
    }
}